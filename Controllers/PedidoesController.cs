...
namespace RyujinBites.Controllers
{
    public class PedidoesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Pedidos.Include(p => p.Cliente).Include(p => p.Cupom);
        ...
        public async Task<IActionResult> Create([Bind("PedidoId,ClienteId,DataPedido,StatusPedido,ValorTotal,TipoEntrega,EnderecoEntrega,Observacoes,CupomId")] Pedido pedido)
        {
